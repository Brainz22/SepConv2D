...
int main(int argc, char **argv) {
    ...
    if (fin.is_open() && fpr.is_open()) {
      ...
      nnet::copy_data<float, input_t, 0, N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1>(in, q_input_1);
      result_t layer2_out[OUT_HEIGHT_2*OUT_WIDTH_2*N_FILT_2];

            // hls-fpga-machine-learning insert top-level-function
            myproject(q_input_1,layer2_out);
    ...
    input_t q_input_1[N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1];
    nnet::fill_zero<input_t, N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1>(q_input_1);
    result_t layer2_out[OUT_HEIGHT_2*OUT_WIDTH_2*N_FILT_2];
